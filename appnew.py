...
if not st.session_state['authenticated']:
    ...
    def generate_all_report(df_data, group_col_input, title):
        ...
        total_row = {c: "" for c in valid_cols}
        total_row[valid_cols[0]] = "GRAND TOTAL"; total_row["Count"] = final['Count'].sum()
        ...
        avg_row = {c: "" for c in valid_cols}
        avg_row[valid_cols[0]] = "AVERAGE PER VEHICLE"; avg_row["Count"] = 1
